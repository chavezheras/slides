...
> [!tod]  Four use cases Four MVPs
> 1. Semantic segmentation
> 2. Context builder (place-based search and retrieval)
> 3. Audience builder (automated audio description)
> 4. Semantic integration (algorithmic creative re-use)
...
>  - Core features only, vanilla back-end, bare-bones interface
...
>- Communicate concepts and get feedback before committing resources
>- Avoid investing in finished products that won't work
...
>- These are the beginning of the next cycle of R&D we are going to undertake
>- Your feedback today shapes the AIMS workshops and Year 2 development
>- Nothing is set in stone — we can drop, merge, or reorient MVPs

---

> [!tip]  The MVP pipeline
>Not a menu of separate prototypes — a linked chain toward deeper transformation
>-  **MVP1**: Break archive material into fragments (reels → segments → frames)
>- **MVP2 & 3**: Add layers of context and audience understanding (metadata)
>- **MVP4**: Semantic integration — transform this dense data into new stories and meanings

> [!done] Links of the chain
> Atomisation → Densification → Integration
...
## MVP2. Place-based search and retrieval
...
## MVP3. Automated audio description
...
## MVP4. Algorithmic editing and creative re-use interfaces
