...
![](fas fa-handshake fa-5x) <!-- .element: color="#b5788d" -->
...
Follow the slides online and live links.
...
![](fas fa-cubes fa-5x) <!-- .element: color="#b5788d" -->
...
![](fas fa-project-diagram fa-5x) <!-- .element: color="#b5788d" -->
...
![](fas fa-laptop-code fa-5x) <!-- .element: color="#b5788d" -->
...
- AIMS 1 \[26 January – 13 March 2026] 
	- Design sprint 
...
![](fas fa-comments fa-5x) <!-- .element: color="#b5788d" -->
...
<div>
![](fas fa-hand-point-down fa-3x)<!-- .element: color="#4C4E52" -->
![](fab fa-slack fa-4x)<!-- .element: color="#992d51"--> 
Slack channel (TBD)
</div>
